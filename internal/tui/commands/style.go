...
func DefaultStyles() Style {
	var style = Style{
		Focused: BaseStyle{
			Base:                  lipgloss.NewStyle().Width(50).Margin(1, 2),
			Title:                 lipgloss.NewStyle().Padding(0, 1).Foreground(lipgloss.Color("#FFFFFF")),
			TitleBar:              lipgloss.NewStyle().Width(48).Margin(0, 1, 1, 1).Background(lipgloss.Color("#64708D")),
		...
		Unfocused: BaseStyle{
			Base:                  lipgloss.NewStyle().Width(50).Margin(1, 2),
			Title:                 lipgloss.NewStyle().Padding(0, 1).Foreground(lipgloss.Color("#FFFFFF")),
			TitleBar:              lipgloss.NewStyle().Width(48).Margin(0, 1, 1, 1).Background(lipgloss.Color("#373B41")),
			Selected:              lipgloss.NewStyle().PaddingLeft(3).Foreground(lipgloss.Color("#AFBEE1")),
			SelectedDescription:   lipgloss.NewStyle().PaddingLeft(3).Foreground(lipgloss.Color("#AFBEE1")),
